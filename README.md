...
- [ ] Разбор гита
  - [ ] Как работают пулреквесты и отправка данных из одного репозитория в другой и как их правильно отправлять
  - [ ] Оформление коммитов
    - [ ] Отсутствие мусора в коде: комментарии, `console.log`
    - [ ] Стиль кода
